...
class ejsRender {
    ...
    constructor(options = {}){
        ...
        this.default_language = options.default_language || "en-US";

        // Initialize LanguageDict if not already initialized
        LanguageDict.initialize(this.dictionary_path, this.default_language);
    }
    ...
    */
    async render(page, data = {}, options = {}){
        ...
        const ejsData = {
            ...
            '__': (key, data = null) => LanguageDict.get(key, data, language)
        };
